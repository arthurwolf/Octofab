...
function Smoothie(){
    ...
    this.send_command = function(passed_data, next){
        ...
        $.post('/command', command + "\n").done(function(data){
            that.terminal_buffer.push("Recv: " + data); 
            console.log(that.terminal_buffer);
